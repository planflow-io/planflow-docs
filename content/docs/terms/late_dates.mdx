...
The latest date a Task can *start* is based on when its [blocked tasks](dependencies) are finished or started, depending on the dependency type (series or parallel).
