...
### Parallel
Tasks in parallel happen at the same time. However, there is always a leader; the first must start before the second can start, AND the first must finish before the second can.
